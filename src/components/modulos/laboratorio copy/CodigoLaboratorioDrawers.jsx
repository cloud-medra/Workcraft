...
/**
 * Overlay compartido para ambos drawers.
 * Se renderiza si alguno de los dos está abierto.
 */
...
/**
 * Etiquetas legibles para cada tipo de acción registrada en el log.
 */
const ACCION_LABELS = {
...
/**
 * Drawer lateral con el historial de auditoría (logs) de un código.
 */
...
/**
 * Drawer lateral de configuración: exportar datos y realizar
 * importaciones masivas desde CSV/XLSX.
 */
