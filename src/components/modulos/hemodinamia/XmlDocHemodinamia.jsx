// src/components/modulos/hemodinamia/XmlDocHemodinamia.jsx
...
const XmlFacturasHemodinamia = () => {
  ...
  const PATH_VISTA = "/hemodinamia/XmlDocHemodinamia";
  const COL_BASE = "hemodinamia_documentos";
  ...
  // Escuchar Documentos del Mes en tiempo real
  useEffect(() => {
  ...
  const onDrop = useCallback(async (acceptedFiles) => {
    ...
    try {
      for (const file of acceptedFiles) {
        ...
        // Referencia (Orden de Compra: TpoDocRef 801)
        ...
        // 1. Guardar documento en Firestore (incluyendo anio y mes)
        ...
        // 2. Generar registro de Log DENTRO de la subcolección del documento creado
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700 px-3 py-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] font-bold text-slate-800 dark:text-gray-100 tracking-wide uppercase">
            Gestión de Documentos XML Hemodinamia
          </span>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 w-full max-w-md rounded-xl shadow-2xl overflow-hidden border border-slate-200 dark:border-gray-700">
            <div className="px-4 py-3 border-b border-slate-100 dark:border-gray-700 flex justify-between items-center bg-slate-50/50 dark:bg-gray-900/40">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-xs text-slate-800 dark:text-gray-100">Importar Documentos XML Hemodinamia</h3>
              </div>
              <button
...
export default XmlFacturasHemodinamia;