        ...
        <div className="p-6 h-full overflow-auto bg-[#F8FAFC]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6 items-start">
            <div className="bg-white p-5 h-[140px] rounded-2xl border border-gray-200 shadow-sm flex flex-col justify-between">
              <div>
                <h3 className="text-[11px] font-bold text-[#0E5B6D] uppercase mb-3 border-b border-gray-100 pb-1 tracking-wider">Detalle de Admisión</h3>
            ...
            <div onClick={() => setShowModalExpediente(true)} className="bg-white p-5 h-[140px] rounded-2xl border border-gray-200 shadow-sm flex items-center gap-4 cursor-pointer hover:border-[#0E5B6D] hover:shadow-md transition-all group">
              <div className="p-4 rounded-2xl bg-amber-50 text-amber-500 group-hover:bg-[#0E5B6D] group-hover:text-white transition-all shadow-inner"><FolderOpen size={36} /></div>
              <div className="flex flex-col justify-center">
                <h3 className="text-[13px] font-bold text-gray-700 group-hover:text-[#0E5B6D] transition-colors">Expediente Digital</h3>
        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col border border-slate-100">
            <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#0E5B6D] bg-[#0E5B6D]/10 px-2.5 py-1 rounded-md">Expediente Centralizado</span>
