          ...
          <table className="w-full text-left text-[12px] border-collapse">
            <thead className="bg-gray-100 dark:bg-gray-900 sticky top-0 z-10 text-gray-600 dark:text-gray-400 uppercase font-bold text-[11px]">
              <tr>
                ...
                <th className="p-3 border-b border-r border-gray-200 dark:border-gray-700">Código</th>
                <th className="p-3 border-b border-r border-gray-200 dark:border-gray-700">Descripción</th>
                <th className="p-3 border-b border-r border-gray-200 dark:border-gray-700">Precio</th>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700/50">
              {codigosFiltrados.map((c) => (
                <tr key={c.id} className="border-l-4 border-transparent hover:border-[#2383C2] dark:hover:border-[#369BCE] hover:bg-gray-50 dark:hover:bg-gray-700/30 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 transition-colors">
                  <td className="p-3 border-r border-gray-200 dark:border-gray-700 font-bold text-gray-700 dark:text-gray-200">{c.referencia}</td>
                  <td className="p-3 border-r border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300">{c.codigo}</td>
                  <td className="p-3 border-r border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 truncate max-w-[300px]">{c.descripcion}</td>
                  <td className="p-3 border-r border-gray-200 dark:border-gray-700 font-medium text-[#2383C2] dark:text-[#369BCE] whitespace-nowrap">$ {Number(c.precio).toLocaleString('es-CL')}</td>
