    ...
    const steps = [
        {
            ...
            icon: <BookOpen className="text-[#0E5B6D]" />
        },
        {
            ...
            icon: <CheckCircle className="text-[#0E5B6D]" />
        },
        {
            ...
            icon: <RefreshCcw className="text-[#0E5B6D]" />
        },
        {
            ...
            icon: <AlertCircle className="text-[#0E5B6D]" />
        }
    ];
    ...
    return (
        <div className="p-8 bg-gray-50/50 min-h-full">
            <div className="max-w-4xl mx-auto">
                    ...
                    {steps.map((step, idx) => (
                        <div key={idx} className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex items-start gap-4">
                                <div className="mt-1 p-2 bg-[#0E5B6D]/10 rounded-lg">{step.icon}</div>
                                        ...
                                        <div className="mt-4 space-y-2">
                                            {step.items.map((item, i) => (
                                                <div key={i} className="flex gap-2 text-[13px]">
                                                    <ChevronRight size={16} className="text-[#0E5B6D] shrink-0" />
                ...
                <div className="mt-8 p-6 bg-[#0E5B6D] rounded-xl text-white shadow-lg">
