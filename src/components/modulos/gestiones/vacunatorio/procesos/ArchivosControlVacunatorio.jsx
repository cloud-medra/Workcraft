...
// src/config/componentMaps/vacunatorio.js) — su visibilidad se decide por
...
const ALL_TABS = [
  { id: 'documentos_recibidos', label: 'Documentos Recibidos', Icon: Inbox, path: '/vacunatorio/archivosControlVacunatorio/documentosRecibidos' },
  { id: 'iniciar_procesos', label: 'Ingreso de Folios', Icon: FileText, path: '/vacunatorio/archivosControlVacunatorio/iniciarProcesos' },
  { id: 'vinculacion_codigos', label: 'Vinculación de Códigos', Icon: ClipboardList, path: '/vacunatorio/archivosControlVacunatorio/vinculacionCodigos' },
  { id: 'vinculacion_ordenes', label: 'Vinculación de Órdenes', Icon: Link2, path: '/vacunatorio/archivosControlVacunatorio/vinculacionOrdenes' },
  { id: 'solicitud_diferencias', label: 'Solicitud Diferencias', Icon: AlertTriangle, path: '/vacunatorio/archivosControlVacunatorio/solicitudDiferencias' },
  { id: 'documentos_listos', label: 'Documentos Listos', Icon: CheckSquare, path: '/vacunatorio/archivosControlVacunatorio/documentosListos' },
  { id: 'documentos_imputados', label: 'Documentos Imputados', Icon: CheckCircle2, path: '/vacunatorio/archivosControlVacunatorio/documentosImputados' },
  { id: 'documentos_edicion', label: 'Edición', Icon: Edit3, path: '/vacunatorio/archivosControlVacunatorio/documentosEdicion' },
];
...
const ArchivosControl = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate-50/60 dark:bg-gray-900 rounded-xl border border-slate-200/80 dark:border-gray-700/80 shadow-xs overflow-hidden">
      ...
      <div className="shrink-0 relative bg-slate-100/60 dark:bg-gray-800/60 px-2 py-1.5 border-b border-slate-200/80 dark:border-gray-700 flex items-center">
