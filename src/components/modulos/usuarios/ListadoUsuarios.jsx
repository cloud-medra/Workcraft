...
const ListadoUsuarios = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden p-0">
      {/* Encabezado Principal idéntico a CrearUsuario */}
      ...
      <div className="bg-gray-50 p-3 flex justify-between items-center border-b border-gray-200">
        <div className="relative w-72">
          ...
          <input 
            ...
            className="w-full h-8 pl-8 pr-2 border border-gray-300 rounded text-[12px] outline-none bg-white focus:border-[#2383C2]" 
            placeholder="Buscar por nombre, usuario o email..." 
          />
        </div>
      </div>

      {/* Contenedor de la Tabla con scroll optimizado */}
        ...
        <table className="w-full text-left text-[12px] border-collapse">
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan="6" className="p-12 text-center text-gray-400 text-[12px]">
              ...
              usuariosFiltrados.map((u, index) => (
                <tr 
                  key={u.id} 
                  className="border-l-4 border-transparent hover:border-[#2383C2] hover:bg-gray-50/80 transition-colors"
                >
                  ...
                  <td className="p-3 border-b border-r border-gray-200">
                    <span className="text-[10px] px-2 py-0.5 rounded font-bold uppercase bg-gray-200 text-gray-700">
                      {u.rol}
                    </span>
                  </td>
