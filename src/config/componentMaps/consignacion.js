    ...
    sections: {
      ...
      filtros: {
        ...
        elements: {
          ...
          select_despachado: { label: 'Campo: Filtro por Despachado (Pendiente/Recibido)' },
      ...
      tabla_registros: {
        ...
        elements: {
          ...
          col_despachado: { label: 'Columna: Despachado (Pendiente/Recibido — automático según N° de Guía)' },
